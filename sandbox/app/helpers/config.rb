module Config
  ...
  MEMORY_LIMIT = (ENV["MEMORY_LIMIT"].presence || 1024000).to_i # in KB
  MAX_MEMORY_LIMIT = (ENV["MAX_MEMORY_LIMIT"].presence || 1024000).to_i
  ...
  ENABLE_PER_PROCESS_AND_THREAD_TIME_LIMIT = ENV["ENABLE_PER_PROCESS_AND_THREAD_TIME_LIMIT"] == "false"
